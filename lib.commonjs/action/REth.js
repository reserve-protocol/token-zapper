...
class RETHToETH extends RocketPoolBase {
    ...
    constructor(universe, router) {
        super(router.reth.address, [router.reth], [universe.nativeToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Callee, [new Approval_1.Approval(router.reth, Address_1.Address.from(router.routerInstance.address))]);
        this.universe = universe;
        this.router = router;
    }
}
