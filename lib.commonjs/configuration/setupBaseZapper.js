...
const setupBaseZapper = async (universe) => {
    ...
    universe.addPreferredRTokenInputToken(universe.rTokens.bsd, universe.commonTokens.WETH);
    universe.addPreferredRTokenInputToken(universe.rTokens.bsd, universe.nativeToken);
    universe.addPreferredRTokenInputToken(universe.rTokens.hyUSD, universe.commonTokens.USDC);
    // Set up stargate
