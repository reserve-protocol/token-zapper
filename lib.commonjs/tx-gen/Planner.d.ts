...
export declare class StatefullPlanner {
    readonly planner: Planner;
    readonly universe: Universe;
    readonly phases: SwapPaths[];
    readonly userInput: TokenQuantity;
    readonly balanceValues: Map<Token, Value>;
    readonly predictedTokenBalances: TokenAmounts;
    readonly tokensHeldByExecutor: Set<Token>;
    private constructor();
    static create(planner: Planner, universe: Universe, phases: SwapPaths[], userInput: TokenQuantity): StatefullPlanner;
    private addInputQuantity;
    generatePlan(userInput: TokenQuantity): void;
    private tokenUsers;
    private analyzePath;
