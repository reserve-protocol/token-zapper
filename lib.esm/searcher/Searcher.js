...
export class Searcher {
    ...
    async findRTokenIntoSingleTokenZap(rTokenQuantity, output, signerAddress, slippage = 0.0) {
        ...
        const [mintResults, tradeResults] = await Promise.all([
            this.findRTokenIntoSingleTokenZapViaIssueance(rTokenQuantity, output, signerAddress, slippage),
    ...
    async findRTokenIntoSingleTokenZapViaIssueance(rTokenQuantity, output, signerAddress, slippage = 0.0) {
        await this.universe.initialized;
        ...
        return new BurnRTokenSearcherResult(this.universe, rTokenQuantity, outputSwap, signerAddress, outputToken);
    }
    ...
    async findSingleInputToRTokenZap_(userInput, rToken, signerAddress, slippage = 0.0) {
        ...
        const searcherResult = new MintRTokenSearcherResult(this.universe, userInput, new SwapPaths(this.universe, [inputTokenQuantity], [...inputQuantityToBasketTokens.swapPaths, rTokenMint], output, rTokenMint.outputValue, signerAddress), signerAddress, rToken);
