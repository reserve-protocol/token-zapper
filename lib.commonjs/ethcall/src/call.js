...
const deploylessMulticall_json_1 = tslib_1.__importDefault(require("./abi/deploylessMulticall.json"));
const deploylessMulticall2_json_1 = tslib_1.__importDefault(require("./abi/deploylessMulticall2.json"));
const deploylessMulticall3_json_1 = tslib_1.__importDefault(require("./abi/deploylessMulticall3.json"));
const multicall_json_1 = tslib_1.__importDefault(require("./abi/multicall.json"));
const multicall2_json_1 = tslib_1.__importDefault(require("./abi/multicall2.json"));
const multicall3_json_1 = tslib_1.__importDefault(require("./abi/multicall3.json"));
const abi_1 = tslib_1.__importDefault(require("./abi"));
