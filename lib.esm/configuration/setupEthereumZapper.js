...
export const setupEthereumZapper = async (universe) => {
    ...
    universe.oracles.push(await PriceOracle.createSingleTokenOracleChainLinkLike(universe, universe.commonTokens.apxETH, Address.from("0x19219BC90F48DeE4d5cF202E09c438FAacFd8Bea"), universe.nativeToken));
