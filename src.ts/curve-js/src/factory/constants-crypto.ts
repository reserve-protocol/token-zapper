...
// --- ZAPS --
import tripoolZapABIJson from '../constants/abis/3pool/meta_zap_crypto.json'
import fraxusdcZapABIJson from '../constants/abis/fraxusdc/meta_zap_crypto.json'

const tripoolZapABI = () => Promise.resolve(tripoolZapABIJson as JsonFragment[])
const fraxusdcZapABI = () =>
  Promise.resolve(fraxusdcZapABIJson as JsonFragment[])
...
export const basePoolIdZapDictFantom: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictAvalanche: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictArbitrum: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictOptimism: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictXDai: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictMoonbeam: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictKava: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}

export const basePoolIdZapDictCelo: IDict<{
  address: string
  ABI: () => Promise<JsonFragment[]>
}> = {}
