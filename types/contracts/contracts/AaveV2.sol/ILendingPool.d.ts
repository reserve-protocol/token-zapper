...
export interface ILendingPool extends BaseContract {
    ...
    functions: {
        ...
        getConfiguration(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[ReserveConfigurationMapStructOutput]>;
        getReserveData(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[ReserveDataStructOutput]>;
        ...
        getUserConfiguration(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[UserConfigurationMapStructOutput]>;
...
//# sourceMappingURL=ILendingPool.d.ts.map