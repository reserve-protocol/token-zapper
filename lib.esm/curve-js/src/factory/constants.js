...
const factorySwapABI = async () => (await import("../constants/abis/factoryPools/swap.json", { assert: { type: "json" } })).default;
const MetaUSDABI = async () => (await import("../constants/abis/factory-v2/MetaUSD.json", { assert: { type: "json" } })).default;
const MetaUSDBalancesABI = async () => (await import("../constants/abis/factory-v2/MetaUSDBalances.json", { assert: { type: "json" } })).default;
const MetaFraxUSDABI = async () => (await import("../constants/abis/factory-v2/MetaFraxUSD.json", { assert: { type: "json" } })).default;
const MetaFraxUSDBalancesABI = async () => (await import("../constants/abis/factory-v2/MetaFraxUSDBalances.json", { assert: { type: "json" } })).default;
const MetaBTCABI = async () => (await import("../constants/abis/factory-v2/MetaBTC.json", { assert: { type: "json" } })).default;
const MetaBTCBalancesABI = async () => (await import("../constants/abis/factory-v2/MetaBTCBalances.json", { assert: { type: "json" } })).default;
const MetaBTCRenABI = async () => (await import("../constants/abis/factory-v2/MetaBTCRen.json", { assert: { type: "json" } })).default;
const MetaBTCRenBalancesABI = async () => (await import("../constants/abis/factory-v2/MetaBTCBalancesRen.json", { assert: { type: "json" } })).default;
const MetaSbtc2ABI = async () => (await import("../constants/abis/factory-v2/MetaSbtc2.json", { assert: { type: "json" } })).default;
const MetaSbtc2BalancesABI = async () => (await import("../constants/abis/factory-v2/MetaSbtc2Balance.json", { assert: { type: "json" } })).default;
const Plain2BasicABI = async () => (await import("../constants/abis/factory-v2/Plain2Basic.json", { assert: { type: "json" } })).default;
const Plain2BalancesABI = async () => (await import("../constants/abis/factory-v2/Plain2Balances.json", { assert: { type: "json" } })).default;
const Plain2ETHABI = async () => (await import("../constants/abis/factory-v2/Plain2ETH.json", { assert: { type: "json" } })).default;
const Plain2OptimizedABI = async () => (await import("../constants/abis/factory-v2/Plain2Optimized.json", { assert: { type: "json" } })).default;
const Plain3BasicABI = async () => (await import("../constants/abis/factory-v2/Plain3Basic.json", { assert: { type: "json" } })).default;
const Plain3BalancesABI = async () => (await import("../constants/abis/factory-v2/Plain3Balances.json", { assert: { type: "json" } })).default;
const Plain3ETHABI = async () => (await import("../constants/abis/factory-v2/Plain3ETH.json", { assert: { type: "json" } })).default;
const Plain3OptimizedABI = async () => (await import("../constants/abis/factory-v2/Plain3Optimized.json", { assert: { type: "json" } })).default;
const Plain4BasicABI = async () => (await import("../constants/abis/factory-v2/Plain4Basic.json", { assert: { type: "json" } })).default;
const Plain4BalancesABI = async () => (await import("../constants/abis/factory-v2/Plain4Balances.json", { assert: { type: "json" } })).default;
const Plain4ETHABI = async () => (await import("../constants/abis/factory-v2/Plain4ETH.json", { assert: { type: "json" } })).default;
const Plain4OptimizedABI = async () => (await import("../constants/abis/factory-v2/Plain4Optimized.json", { assert: { type: "json" } })).default;
// --- ZAPS --
const factoryDepositABI = async () => (await import("../constants/abis/factoryPools/deposit.json", { assert: { type: "json" } })).default;
const fraxusdcMetaZapABI = async () => (await import("../constants/abis/fraxusdc/meta_zap.json", { assert: { type: "json" } })).default;
const RenMetaZapABI = async () => (await import("../constants/abis/ren/meta_zap.json", { assert: { type: "json" } })).default;
const Sbtc2MetaZapABI = async () => (await import("../constants/abis/sbtc2/meta_zap.json", { assert: { type: "json" } })).default;
