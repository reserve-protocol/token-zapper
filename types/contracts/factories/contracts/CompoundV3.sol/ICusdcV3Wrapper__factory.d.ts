...
import type { ICusdcV3Wrapper, ICusdcV3WrapperInterface } from "../../../contracts/CompoundV3.sol/ICusdcV3Wrapper";
export declare class ICusdcV3Wrapper__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "convertDynamicToStatic";
        readonly outputs: readonly [{
        ...
        readonly name: "convertStaticToDynamic";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
        ...
        readonly outputs: readonly [{
            ...
            readonly internalType: "struct TotalsBasic";
            readonly name: "";
            readonly type: "tuple";
        }];
        readonly stateMutability: "view";
        ...
        readonly name: "underlyingBalanceOf";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
    ...
    static createInterface(): ICusdcV3WrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ICusdcV3Wrapper;
}
//# sourceMappingURL=ICusdcV3Wrapper__factory.d.ts.map