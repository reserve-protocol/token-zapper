...
export declare const ONE_Val: gen.LiteralValue;
export declare const plannerUtils: {
    ...
    fraction: (uni: Universe, planner: gen.Planner, input: gen.Value, fraction: bigint, comment: string, name?: string) => gen.Value | gen.ReturnValue;
    sub: (uni: Universe, planner: gen.Planner, a: gen.Value | bigint, b: gen.Value | bigint, comment: string, name?: string) => gen.ReturnValue;
    erc20: {
...
export declare abstract class BaseAction {
    ...
    readonly genUtils: {
        ...
        fraction: (uni: Universe<import("..").Config>, planner: gen.Planner, input: gen.Value, fraction: bigint, comment: string, name?: string | undefined) => gen.Value | gen.ReturnValue;
