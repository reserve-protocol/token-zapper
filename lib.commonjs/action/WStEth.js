...
const wstETHInterface = contracts_1.IWStETH__factory.createInterface();
class WStETHRateProvider {
    ...
    constructor(universe, steth, wsteth) {
        ...
        this.steth = steth;
        this.wsteth = wsteth;
        this.wstethInstance = contracts_1.IWStETH__factory.connect(wsteth.address.address, universe.provider);
    }
...
class MintWStETH extends Action_1.Action {
    ...
    async encode([amountsIn]) {
        ...
        return new ContractCall_1.ContractCall((0, base_1.parseHexStringIntoBuffer)(hexEncodedWrapCall), this.wsteth.address, 0n, this.gasEstimate(), 'Mint wstETH');
    }
