...
class CryptoFactoryPoolSwapMint extends CurveFactoryCryptoPoolBase {
    ...
    constructor(pool) {
        super(pool.lpToken.address, pool.underlying, [pool.lpToken], InteractionConvention.ApprovalRequired, DestinationOptions.Callee, pool.underlying.map((token) => new Approval(token, pool.pool)));
        this.pool = pool;
    }
}
...
class CurveFactoryCryptoPoolAddLiquidityAction extends Action('CurveFactoryCryptoPool') {
    ...
    constructor(universe, pool, tokenIndex) {
        super(pool.underlying[tokenIndex].address, [pool.underlying[tokenIndex]], [pool.lpToken], InteractionConvention.ApprovalRequired, DestinationOptions.Recipient, pool.underlying.map((token) => new Approval(token === universe.nativeToken
...
class CurveFactoryCryptoPoolRemoveLiquidityAction extends Action('CurveFactoryCryptoPool') {
    ...
    constructor(universe, pool, tokenIndex) {
        super(pool.underlying[tokenIndex].address, [pool.lpToken], [pool.underlying[tokenIndex]], InteractionConvention.None, DestinationOptions.Callee, []);
        this.universe = universe;
        this.pool = pool;
        this.tokenIndex = tokenIndex;
