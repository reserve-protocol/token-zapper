...
import { ETHTokenVault__factory, IStakedEthenaUSD__factory, } from '../contracts';
...
export const ETHTokenVaultDepositAction = (proto) => class ETHTokenVaultDepositAction extends Action(proto) {
    ...
    constructor(universe, underlying, shareToken, slippage) {
        ...
        this.inst = ETHTokenVault__factory.connect(this.shareToken.address.address, this.universe.provider);
