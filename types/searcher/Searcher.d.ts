...
import { BaseSearcherResult, BurnRTokenSearcherResult } from './SearcherResult';
...
export declare class Searcher<const SearcherUniverse extends UniverseWithERC20GasTokenDefined> {
    ...
    findRTokenIntoSingleTokenZap(rTokenQuantity: TokenQuantity, output: Token, signerAddress: Address, slippage?: number): Promise<BaseSearcherResult>;
    findRTokenIntoSingleTokenZapViaIssueance(rTokenQuantity: TokenQuantity, output: Token, signerAddress: Address, slippage?: number): Promise<BurnRTokenSearcherResult>;
    ...
    findTokenZapViaTrade(userInput: TokenQuantity, rToken: Token, signerAddress: Address, slippage?: number): Promise<BaseSearcherResult[]>;
    findSingleInputToRTokenZap(userInput: TokenQuantity, rToken: Token, signerAddress: Address, slippage?: number): Promise<BaseSearcherResult>;
