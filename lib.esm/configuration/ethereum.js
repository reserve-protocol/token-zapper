...
const loadCompoundTokens = async (cEther, comptrollerAddress, universe) => {
    const allCTokens = await IComptroller__factory.connect(comptrollerAddress, universe.provider).getAllMarkets();
...
const initialize = async (universe) => {
    ...
    const cEther = await universe.getToken(Address.from('0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5'));
