...
export declare namespace IAerodromePool {
...
export interface IAerodromePoolInterface extends utils.Interface {
  functions: {
...
export interface IAerodromePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAerodromePoolInterface;
  ...
  functions: {
    ...
    lastObservation(
      overrides?: CallOverrides
    ): Promise<[IAerodromePool.ObservationStructOutput]>;
