...
export declare class Universe<const UniverseConf extends Config = Config> {
    ...
    canZapIntoRToken(token: Token): Promise<{
        canZap: boolean;
        tokensMissings: Token[];
    }>;
    private constructor();
    updateBlockState(block: number, gasPrice: bigint): Promise<void>;
    static createWithConfig<const C extends Config>(provider: ethers.providers.Provider, config: C, initialize: (universe: Universe<C>) => Promise<void>, opts?: Partial<{
    ...
    zap(tokenIn: string, amountIn: bigint, rToken: string, signerAddress: string): Promise<import("./searcher/SearcherResult").BaseSearcherResult>;
    zapETH(amountIn: bigint, rToken: string, signerAddress: string): Promise<import("./searcher/SearcherResult").BaseSearcherResult>;
    redeem(rToken: string, amount: bigint, output: string, signerAddress: string): Promise<import("./searcher/SearcherResult").BurnRTokenSearcherResult | import("./searcher/SearcherResult").TradeSearcherResult>;
}
export {};
