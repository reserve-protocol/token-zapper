...
import { ETHTokenVault, IERC4626 } from '../contracts';
...
export declare const ETHTokenVaultDepositAction: (proto: string) => {
    new (universe: Universe, shareToken: Token, vaultAddress: Address, slippage: bigint): {
