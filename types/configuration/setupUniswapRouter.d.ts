...
declare const UniswapRouterAction_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
    ...
    readonly genUtils: {
        ...
        fraction: (uni: Universe<import("./ChainConfiguration").Config>, planner: Planner, input: Value, fraction: bigint, comment: string, name?: string | undefined) => Value | import("../tx-gen/Planner").ReturnValue;
        sub: (uni: Universe<import("./ChainConfiguration").Config>, planner: Planner, a: bigint | Value, b: bigint | Value, comment: string, name?: string | undefined) => import("../tx-gen/Planner").ReturnValue;
        erc20: {
