...
class MintCTokenAction extends Action_1.Action {
    ...
    async plan(planner, inputs) {
        ...
        const balanceOfLib = this.gen.Contract.createContract(contracts_1.BalanceOf__factory.connect(this.universe.config.addresses.balanceOf.address, this.universe.provider));
        return [
