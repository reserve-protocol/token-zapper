...
export interface PreventSelfDestructInterface extends utils.Interface {
    functions: {
...
export interface PreventSelfDestruct extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PreventSelfDestructInterface;
...
//# sourceMappingURL=PreventSelfDestruct.d.ts.map