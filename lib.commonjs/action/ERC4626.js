...
const IERC4626__factory_1 = require("../contracts/factories/IERC4626__factory");
...
class ERC4626DepositAction extends Action_1.Action {
    ...
    async quote([amountsIn]) {
        return [
            this.shareToken.from(await IERC4626__factory_1.IERC4626__factory.connect(this.shareToken.address.address, this.universe.provider).previewDeposit(amountsIn.amount)),
        ];
    }
