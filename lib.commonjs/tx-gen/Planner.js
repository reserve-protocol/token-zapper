...
exports.printPlan = exports.Planner = exports.CommandType = exports.Contract = exports.encodeArg = exports.isDynamicType = exports.FunctionCall = exports.CommandFlags = exports.SubplanValue = exports.StateValue = exports.ReturnValue = exports.TupleLiteral = exports.LiteralValue = void 0;
...
const printPlan = (plan, universe) => {
    ...
    for (let i = 0; i < plan.commands.length; i++) {
        ...
        const finalStr = retVal == null
            ? `${prefix} ${formatted} # sighash: ${step.call.contract.interface.getSighash(step.call.fragment)}`
