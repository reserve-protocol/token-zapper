...
class OneInchAction extends Action_1.Action {
    ...
    async encode() {
        ...
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(swap.tx.data), Address_1.Address.fromHexString(swap.tx.to), BigInt(swap.tx.value), this.gasEstimate(), `1Inch Swap (...)`);
    }
    toString() {
        return `OneInch(path=[...])`;
    }
