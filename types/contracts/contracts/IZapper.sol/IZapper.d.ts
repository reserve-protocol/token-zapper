...
export interface IZapper extends BaseContract {
    ...
    callStatic: {
        zapERC20(params: ZapERC20ParamsStruct, overrides?: CallOverrides): Promise<void>;
        zapERC20WithPermit2(params: ZapERC20ParamsStruct, permit: PermitTransferFromStruct, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        zapETH(params: ZapERC20ParamsStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        zapERC20(params: ZapERC20ParamsStruct, overrides?: Overrides & {
...
//# sourceMappingURL=IZapper.d.ts.map