...
class REthRouter {
    ...
    async optimiseToREth(qtyETH) {
        ...
        return {
            ...
            contractCall: new ContractCall_1.ContractCall((0, utils_2.parseHexStringIntoBuffer)(this.routerInstance.interface.encodeFunctionData('swapTo', [
                params.portions[0],
                params.portions[1],
                params.amountOut,
                params.amountOut,
    ...
    async optimiseFromREth(qtyETH) {
        ...
        return {
            ...
            contractCall: new ContractCall_1.ContractCall((0, utils_2.parseHexStringIntoBuffer)(this.routerInstance.interface.encodeFunctionData('swapFrom', [
                params.portions[0],
                params.portions[1],
                params.amountOut,
                params.amountOut,
