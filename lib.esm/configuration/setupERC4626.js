...
export const setupERC4626 = async (universe, vaultAddr, protocol, slippage) => {
    ...
    for (const { wrappedToken, underlying } of tokens) {
        universe.defineMintable(new (ERC4626DepositAction(protocol))(universe, underlying, wrappedToken, slippage), new (ERC4626WithdrawAction(protocol))(universe, underlying, wrappedToken, slippage), false);
    }
};
