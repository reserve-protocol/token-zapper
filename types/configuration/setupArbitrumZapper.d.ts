...
export declare const setupArbitrumZapper: (universe: ArbitrumUniverse) => Promise<{
    uni: {
        dex: import("..").DexAggregator;
    ...
    compV3: {
        readonly comets: {
            ...
            readonly mintAction: {
                ...
                generateOutputTokenBalance(universe: import("..").Universe<import("./ChainConfiguration").Config>, planner: import("../tx-gen/Planner").Planner, comment?: string | undefined): import("../tx-gen/Planner").Value;
...
//# sourceMappingURL=setupArbitrumZapper.d.ts.map