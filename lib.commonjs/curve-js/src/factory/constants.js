...
const factorySwapABI = () => import("../constants/abis/factoryPools/swap.json", { assert: { type: "json" } }).then(i => i.default);
const MetaUSDABI = () => import("../constants/abis/factory-v2/MetaUSD.json", { assert: { type: "json" } }).then(i => i.default);
const MetaUSDBalancesABI = () => import("../constants/abis/factory-v2/MetaUSDBalances.json", { assert: { type: "json" } }).then(i => i.default);
const MetaFraxUSDABI = () => import("../constants/abis/factory-v2/MetaFraxUSD.json", { assert: { type: "json" } }).then(i => i.default);
const MetaFraxUSDBalancesABI = () => import("../constants/abis/factory-v2/MetaFraxUSDBalances.json", { assert: { type: "json" } }).then(i => i.default);
const MetaBTCABI = () => import("../constants/abis/factory-v2/MetaBTC.json", { assert: { type: "json" } }).then(i => i.default);
const MetaBTCBalancesABI = () => import("../constants/abis/factory-v2/MetaBTCBalances.json", { assert: { type: "json" } }).then(i => i.default);
const MetaBTCRenABI = () => import("../constants/abis/factory-v2/MetaBTCRen.json", { assert: { type: "json" } }).then(i => i.default);
const MetaBTCRenBalancesABI = () => import("../constants/abis/factory-v2/MetaBTCBalancesRen.json", { assert: { type: "json" } }).then(i => i.default);
const MetaSbtc2ABI = () => import("../constants/abis/factory-v2/MetaSbtc2.json", { assert: { type: "json" } }).then(i => i.default);
const MetaSbtc2BalancesABI = () => import("../constants/abis/factory-v2/MetaSbtc2Balance.json", { assert: { type: "json" } }).then(i => i.default);
const Plain2BasicABI = () => import("../constants/abis/factory-v2/Plain2Basic.json", { assert: { type: "json" } }).then(i => i.default);
const Plain2BalancesABI = () => import("../constants/abis/factory-v2/Plain2Balances.json", { assert: { type: "json" } }).then(i => i.default);
const Plain2ETHABI = () => import("../constants/abis/factory-v2/Plain2ETH.json", { assert: { type: "json" } }).then(i => i.default);
const Plain2OptimizedABI = () => import("../constants/abis/factory-v2/Plain2Optimized.json", { assert: { type: "json" } }).then(i => i.default);
const Plain3BasicABI = () => import("../constants/abis/factory-v2/Plain3Basic.json", { assert: { type: "json" } }).then(i => i.default);
const Plain3BalancesABI = () => import("../constants/abis/factory-v2/Plain3Balances.json", { assert: { type: "json" } }).then(i => i.default);
const Plain3ETHABI = () => import("../constants/abis/factory-v2/Plain3ETH.json", { assert: { type: "json" } }).then(i => i.default);
const Plain3OptimizedABI = () => import("../constants/abis/factory-v2/Plain3Optimized.json", { assert: { type: "json" } }).then(i => i.default);
const Plain4BasicABI = () => import("../constants/abis/factory-v2/Plain4Basic.json", { assert: { type: "json" } }).then(i => i.default);
const Plain4BalancesABI = () => import("../constants/abis/factory-v2/Plain4Balances.json", { assert: { type: "json" } }).then(i => i.default);
const Plain4ETHABI = () => import("../constants/abis/factory-v2/Plain4ETH.json", { assert: { type: "json" } }).then(i => i.default);
const Plain4OptimizedABI = () => import("../constants/abis/factory-v2/Plain4Optimized.json", { assert: { type: "json" } }).then(i => i.default);
// --- ZAPS --
const factoryDepositABI = () => import("../constants/abis/factoryPools/deposit.json", { assert: { type: "json" } }).then(i => i.default);
const fraxusdcMetaZapABI = () => import("../constants/abis/fraxusdc/meta_zap.json", { assert: { type: "json" } }).then(i => i.default);
const RenMetaZapABI = () => import("../constants/abis/ren/meta_zap.json", { assert: { type: "json" } }).then(i => i.default);
const Sbtc2MetaZapABI = () => import("../constants/abis/sbtc2/meta_zap.json", { assert: { type: "json" } }).then(i => i.default);
