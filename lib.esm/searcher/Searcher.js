...
export class Searcher {
    ...
    async findSingleInputToRTokenZap(userInput, rToken, signerAddress, slippage = 0.0) {
        ...
        const searcherResult = new SearcherResult(this.universe, new SwapPaths(this.universe, [userInput], [...inputQuantityToBasketTokens.swapPaths, rTokenMint], output, rTokenMint.outputValue, signerAddress), signerAddress, rToken);
