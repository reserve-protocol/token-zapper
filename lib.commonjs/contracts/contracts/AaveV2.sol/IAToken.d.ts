...
export interface IATokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "UNDERLYING_ASSET_ADDRESS" | "allowance" | "approve" | "balanceOf" | "burn" | "getScaledUserBalanceAndSupply" | "handleRepayment" | "mint" | "mintToTreasury" | "scaledBalanceOf" | "scaledTotalSupply" | "totalSupply" | "transfer" | "transferFrom" | "transferOnLiquidation" | "transferUnderlyingTo"): FunctionFragment;
