...
export interface IPoolInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getReservesCount", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getReservesCount", data: BytesLike): Result;
