...
import type {
  IMaverickV2Factory,
  IMaverickV2FactoryInterface,
} from "../../../contracts/Maverick.sol/IMaverickV2Factory";
...
export class IMaverickV2Factory__factory {
  static readonly abi = _abi;
  static createInterface(): IMaverickV2FactoryInterface {
    return new utils.Interface(_abi) as IMaverickV2FactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMaverickV2Factory {
    return new Contract(address, _abi, signerOrProvider) as IMaverickV2Factory;
  }
}
