...
declare const BaseConvexStakingWrapper_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
    ...
    readonly genUtils: {
        ...
        fraction: (uni: import("..").Universe<import("./ChainConfiguration").Config>, planner: Planner, input: Value, fraction: bigint, comment: string, name?: string | undefined) => import("../tx-gen/Planner").ReturnValue;
