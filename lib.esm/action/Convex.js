...
import { Address, Approval, ContractCall, parseHexStringIntoBuffer, } from '../base';
import { IBooster__factory, IConvexBaseRewardsPool__factory, IConvexWrapper__factory, } from '../contracts';
class ConvexPool {
    convexBooster;
    convexPoolId;
    curveLPToken;
...
const baseRewardsPoolInterface = IConvexBaseRewardsPool__factory.createInterface();
 ...
 */
export const setupConvexEdges = async (universe, stakedConvexToken) => {
    const convexBooster = IBooster__factory.connect(universe.config.addresses.convex.address, universe.provider);
