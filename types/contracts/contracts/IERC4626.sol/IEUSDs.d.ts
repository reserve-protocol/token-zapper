...
export interface IEUSDsInterface extends utils.Interface {
    functions: {
...
export interface IEUSDs extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IEUSDsInterface;
...
//# sourceMappingURL=IEUSDs.d.ts.map