...
const initialize = async (universe) => {
    ...
    if (universe.chainConfig.config.curveConfig.enable) {
        ...
        const _3CRV = await universe.getToken(Address_1.Address.from('0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490'));
        ...
        const stkcvx3Crv = await universe.getToken(Address_1.Address.from('0xee0ac49885719DBF5FC1CDAFD9c752127E009fFa'));
        ...
        const [eUSDConvex, mimConvex, threeCryptoConvex] = await Promise.all([
            ...
            (0, Convex_1.setupConvexEdges)(universe, stkcvx3Crv)
        ]);
    ...
    const saDAI = await universe.getToken(Address_1.Address.from('0xF6147b4B44aE6240F7955803B2fD5E15c77bD7ea'));
    const saTokens = [
...
const ethereumConfig = {
    config: new StaticConfig_1.StaticConfig({
        ...
        rTokenDeployments: {
            ...
            iUSD: Address_1.Address.from('0x555143D2E6653c80a399f77c612D33D5Bf67F331'),
        },
