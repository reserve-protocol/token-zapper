...
import { CurveFactoryCryptoPool } from '../action/CurveFactoryCryptoPool';
...
export declare class CurveIntegration {
    ...
    readonly specialCasePools: Awaited<ReturnType<typeof convertPoolListIntoMaps<CurveStableSwapNGPool | CurveFactoryCryptoPool>>>;
    ...
    findWithdrawActions(lpToken: Token): Promise<import("../action/Action").BaseAction[] | (import("../action/Curve").CurveSwap | null)[]>;
    findDepositAction(input: TokenQuantity, lpToken: Token): Promise<import("../action/Action").BaseAction>;
    toString(): string;
}
export {};
//# sourceMappingURL=setupCurve.d.ts.map