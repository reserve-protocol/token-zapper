...
const gaugeABI = () => import("../abis/gauge.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeSynthetixABI = () => import("../abis/gauge_synthetix.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeV2ABI = () => import("../abis/gauge_v2.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeV3ABI = () => import("../abis/gauge_v3.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeV4ABI = () => import("../abis/gauge_v4.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeV5ABI = () => import("../abis/gauge_v5.json", { assert: { type: "json" } }).then(i => i.default);
const gaugeFactoryABI = () => import("../abis/gauge_factory.json", { assert: { type: "json" } }).then(i => i.default);
const compoundDepositABI = () => import('../abis/compound/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const compoundSwapABI = () => import('../abis/compound/swap.json', { assert: { type: "json" } }).then(i => i.default);
const usdtDepositABI = () => import('../abis/usdt/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const usdtSwapABI = () => import('../abis/usdt/swap.json', { assert: { type: "json" } }).then(i => i.default);
const iearnDepositABI = () => import('../abis/iearn/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const iearnSwapABI = () => import('../abis/iearn/swap.json', { assert: { type: "json" } }).then(i => i.default);
const busdDepositABI = () => import('../abis/busd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const busdSwapABI = () => import('../abis/busd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const susdv2DepositABI = () => import('../abis/susdv2/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const susdv2SwapABI = () => import('../abis/susdv2/swap.json', { assert: { type: "json" } }).then(i => i.default);
const susdv2SCurveRewards_abi = () => import('../abis/susdv2/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const paxDepositABI = () => import('../abis/pax/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const paxSwapABI = () => import('../abis/pax/swap.json', { assert: { type: "json" } }).then(i => i.default);
const renSwapABI = () => import('../abis/ren/swap.json', { assert: { type: "json" } }).then(i => i.default);
const sbtcSwapABI = () => import('../abis/sbtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const sbtcSCurveRewardsABI = () => import('../abis/sbtc/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const hbtcSwapABI = () => import('../abis/hbtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const tripoolSwapABI = () => import('../abis/3pool/swap.json', { assert: { type: "json" } }).then(i => i.default);
const gusdSwapABI = () => import('../abis/gusd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const gusdDepositABI = () => import('../abis/gusd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const husdSwapABI = () => import('../abis/husd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const husdDepositABI = () => import('../abis/husd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const usdkSwapABI = () => import('../abis/usdk/swap.json', { assert: { type: "json" } }).then(i => i.default);
const usdkDepositABI = () => import('../abis/usdk/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const usdnSwapABI = () => import('../abis/usdn/swap.json', { assert: { type: "json" } }).then(i => i.default);
const usdnDepositABI = () => import('../abis/usdn/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const musdSwapABI = () => import('../abis/musd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const musdDepositABI = () => import('../abis/musd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const musdSCurveRewards_abi = () => import('../abis/musd/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const rsvSwapABI = () => import('../abis/rsv/swap.json', { assert: { type: "json" } }).then(i => i.default);
const rsvDepositABI = () => import('../abis/rsv/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const rsvSCurveRewards_abi = () => import('../abis/rsv/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const tbtcSwapABI = () => import('../abis/tbtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const tbtcDepositABI = () => import('../abis/tbtc/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const tbtcSCurveRewards_abi = () => import('../abis/tbtc/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const dusdSwapABI = () => import('../abis/dusd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const dusdDepositABI = () => import('../abis/dusd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const dusdSCurveRewards_abi = () => import('../abis/dusd/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const pbtcSwapABI = () => import('../abis/pbtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const pbtcDepositABI = () => import('../abis/pbtc/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const pbtcSCurveRewards_abi = () => import('../abis/pbtc/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const bbtcSwapABI = () => import('../abis/bbtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const bbtcDepositABI = () => import('../abis/bbtc/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const obtcSwapABI = () => import('../abis/obtc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const obtcDepositABI = () => import('../abis/obtc/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const obtcSCurveRewards_abi = () => import('../abis/obtc/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const sethSwapABI = () => import('../abis/seth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const eursSwapABI = () => import('../abis/eurs/swap.json', { assert: { type: "json" } }).then(i => i.default);
const eursSCurveRewards_abi = () => import('../abis/eurs/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const ustSwapABI = () => import('../abis/ust/swap.json', { assert: { type: "json" } }).then(i => i.default);
const ustDepositABI = () => import('../abis/ust/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const aaveSwapABI = () => import('../abis/aave/swap.json', { assert: { type: "json" } }).then(i => i.default);
const aaveRewardsABI = () => import('../abis/aave/rewards.json', { assert: { type: "json" } }).then(i => i.default);
const stethSwapABI = () => import('../abis/steth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const stethSCurveRewards_abi = () => import('../abis/steth/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const saaveSwapABI = () => import('../abis/saave/swap.json', { assert: { type: "json" } }).then(i => i.default);
const ankrethSwapABI = () => import('../abis/ankreth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const ankrethSCurveRewards_abi = () => import('../abis/ankreth/sCurveRewards.json', { assert: { type: "json" } }).then(i => i.default);
const usdpSwapABI = () => import('../abis/usdp/swap.json', { assert: { type: "json" } }).then(i => i.default);
const usdpDepositABI = () => import('../abis/usdp/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const ibSwapABI = () => import('../abis/ib/swap.json', { assert: { type: "json" } }).then(i => i.default);
const linkSwapABI = () => import('../abis/link/swap.json', { assert: { type: "json" } }).then(i => i.default);
const rethSwapABI = () => import('../abis/reth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const factorySwapABI = () => import('../abis/factoryPools/swap.json', { assert: { type: "json" } }).then(i => i.default);
const factoryDepositABI = () => import('../abis/factoryPools/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const factoryRewardsABI = () => import('../abis/factoryPools/rewards.json', { assert: { type: "json" } }).then(i => i.default);
const tricrypto2SwapABI = () => import('../abis/tricrypto2/swap.json', { assert: { type: "json" } }).then(i => i.default);
const tricrypto2DepositABI = () => import('../abis/tricrypto2/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const eurtSwapABI = () => import('../abis/eurt/swap.json', { assert: { type: "json" } }).then(i => i.default);
const eurtusdSwapABI = () => import('../abis/eurtusd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const eurtusdDepositABI = () => import('../abis/eurtusd/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const eursusdSwapABI = () => import('../abis/eursusd/swap.json', { assert: { type: "json" } }).then(i => i.default);
const crvethSwapABI = () => import('../abis/crveth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const raiSwapABI = () => import('../abis/rai/swap.json', { assert: { type: "json" } }).then(i => i.default);
const raiDepositABI = () => import('../abis/rai/deposit.json', { assert: { type: "json" } }).then(i => i.default);
const twopoolSwapABI = () => import('../abis/2pool/swap.json', { assert: { type: "json" } }).then(i => i.default);
const fourpoolSwapABI = () => import('../abis/4pool/swap.json', { assert: { type: "json" } }).then(i => i.default);
const fraxusdcSwapABI = () => import('../abis/fraxusdc/swap.json', { assert: { type: "json" } }).then(i => i.default);
const frxethSwapABI = () => import('../abis/frxeth/swap.json', { assert: { type: "json" } }).then(i => i.default);
const sbtc2SwapABI = () => import('../abis/sbtc2/swap.json', { assert: { type: "json" } }).then(i => i.default);
