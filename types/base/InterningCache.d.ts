 ...
 * ```
 */
export declare class InterningCache<T extends object, IDType extends string | number | bigint = string> {
    private readonly idFn;
    private readonly entities;
    constructor(idFn: (t: T) => IDType);
    private lastCollect;
    get size(): number;
    collect(): void;
    getById(key: IDType): WeakRef<T> | undefined;
    get(inst: T): T;
    toString(): string;
    readonly [Symbol.toStringTag] = "InterningCache";
}
//# sourceMappingURL=InterningCache.d.ts.map