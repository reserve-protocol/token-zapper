...
exports.setupERC4626s = exports.setupERC4626 = exports.ERC4626Deployment = void 0;
...
class ERC4626Deployment {
    ...
    mint;
    burn;
    constructor(protocol, universe, shareToken, assetToken, slippage) {
    ...
    static async load(universe, protocol, shareTokenAddress, slippage) {
...
exports.ERC4626Deployment = ERC4626Deployment;
