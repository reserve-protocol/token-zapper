...
export interface IRTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "basketsNeeded" | "issue" | "issueTo" | "mint" | "redeem" | "redeemTo" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
