...
export class Token {
    ...
    fromDecimal(decimalStringOrNumber) {
        ...
        return new TokenQuantity(this, parseUnits(decimalStringOrNumber, this.decimals).toBigInt());
    }
...
export class TokenQuantity {
    ...
    formatWithSymbol() {
        return (formatUnits(this.amount, this.token.decimals) + ' ' + this.token.symbol);
    }
    toScaled(scale) {
