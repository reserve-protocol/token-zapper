...
const loadRToken = async (universe, rTokenAddress) => {
    const rtokenMain = contracts_1.IRToken__factory.connect(rTokenAddress.address, universe.provider);
    const mainAddr = Address_1.Address.from(await rtokenMain.main());
