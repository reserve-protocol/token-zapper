 ...
 */
export declare const findPrecursorTokenSet: (universe: Universe, userInputQuantity: TokenQuantity, rToken: Token, unitBasket: TokenQuantity[]) => Promise<BasketTokenSourcingRuleApplication>;
