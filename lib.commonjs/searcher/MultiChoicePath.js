...
const generateAllPermutations = async function (searcher, arr, precursorTokens) {
    ...
    const withoutComflicts = allCombos.filter((paths) => willPathsHaveAddressConflicts(universe, paths).length === 0);
...
const willPathsHaveAddressConflicts = (universe, paths) => {
