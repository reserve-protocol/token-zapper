...
class Searcher {
        ...
        const outputSwap = new Swap_1.SwapPaths(this.universe, [rTokenQuantity], [
            ...redeemRTokenForUnderlying.swapPaths.map(i => {
                if (i.outputs.length === 1 && i.outputs[0].token === outputToken) {
                    return new Swap_1.SwapPath(i.universe, i.inputs, i.steps, i.outputs, i.outputValue, signerAddress);
                }
                return i;
            }),
    ...
    findSingleInputToRTokenZap(userInput, rToken, signerAddress, slippage = 0.0) {
        ...
        //   slippage
        // )
        return (0, base_1.retryLoop)(() => this.findSingleInputToRTokenZap_(userInput, rToken, signerAddress, slippage), {
            maxRetries: 3,
            retryDelay: 500,
        });
    }
