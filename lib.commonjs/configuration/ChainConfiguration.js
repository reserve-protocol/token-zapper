...
exports.makeConfig = exports.convertAddressObject = void 0;
...
exports.convertAddressObject = convertAddressObject;
const makeConfig = (chainId, nativeToken, commonTokens, rTokens, addresses, options) => {
    return {
        chainId,
        nativeToken,
        addresses: {
            ...(0, exports.convertAddressObject)(addresses),
            commonTokens: (0, exports.convertAddressObject)(commonTokens),
            rTokens: (0, exports.convertAddressObject)(Object.fromEntries(Object.entries(rTokens).map((i) => [i[0], i[1]]))),
        },
