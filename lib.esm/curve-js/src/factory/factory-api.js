...
const factoryGaugeABI = async () => (await import("../constants/abis/gauge_factory.json", { assert: { type: "json" } })).default;
const gaugeChildABI = async () => (await import("../constants/abis/gauge_child.json", { assert: { type: "json" } })).default;
const cryptoFactorySwapABI = async () => (await import("../constants/abis/factory-crypto/factory-crypto-pool-2.json", { assert: { type: "json" } })).default;
