...
export declare const arbiConfig: {
    ...
    readonly addresses: {
        readonly commonTokens: {
            ...
            readonly USDM: import("..").Address;
            readonly WUSDM: import("..").Address;
            readonly FRAX: import("..").Address;
        };
        readonly rTokens: {
            KNOX: import("..").Address;
            _rTokenWithWUSDM: import("..").Address;
        };
...
export declare const PROTOCOL_CONFIGS: {
    readonly oracles: {
        USD: {
            ...
            "0x57F5E098CaD7A3D1Eed53991D4d66C45C9AF7812": string;
