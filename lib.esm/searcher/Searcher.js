...
export class Searcher {
    ...
    async findSingleInputToBasketGivenBasketUnit(inputQuantity, rToken, basketUnit, internalTradeSlippage, onResult, abortSignal) {
         ...
         */
        const precursorTokens = await this.perf.measurePromise('findPrecursorTokenSet', findPrecursorTokenSet(this.universe, inputQuantity, rToken, basketUnit, this), rToken.symbol);
