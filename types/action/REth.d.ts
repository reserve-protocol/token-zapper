...
declare const RocketPoolBase_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
...
export declare class ETHToRETH extends RocketPoolBase {
    ...
    plan(planner: Planner, [input_]: Value[], _: Address, [inputPrecomputed]: TokenQuantity[]): Promise<null>;
    gasEstimate(): bigint;
...
export declare class WETHToRETH extends RocketPoolBase {
    ...
    get outputSlippage(): bigint;
    get returnsOutput(): boolean;
    plan(planner: Planner, [input]: Value[], _: Address, [inputPrecomputed]: TokenQuantity[]): Promise<null>;
    gasEstimate(): bigint;
    quote([input]: TokenQuantity[]): Promise<TokenQuantity[]>;
    constructor(universe: Universe, router: IRouter);
    get supportsDynamicInput(): boolean;
