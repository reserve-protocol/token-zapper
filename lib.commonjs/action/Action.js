...
exports.Action = exports.createMultiChoiceAction = exports.isMultiChoiceEdge = exports.BaseAction = exports.plannerUtils = exports.ONE_Val = exports.ONE = exports.EdgeType = exports.DestinationOptions = exports.InteractionConvention = void 0;
...
exports.ONE = 10n ** 18n;
exports.ONE_Val = new gen.LiteralValue(abi_1.ParamType.fromString('uint256'), abi_1.defaultAbiCoder.encode(['uint256'], [exports.ONE]));
exports.plannerUtils = {
    ...
    fraction: (uni, planner, input, fraction, comment, name) => {
        if (input instanceof gen.LiteralValue) {
            return gen.encodeArg(BigInt(input.value) * fraction / exports.ONE, abi_1.ParamType.from('uint256'));
        }
        return planner.add(uni.weirollZapperExec.fpMul(input, fraction, exports.ONE_Val), `${(parseFloat((0, utils_1.formatEther)(fraction)) * 100).toFixed(2)}% ${comment}`, name);
    },
    sub: (uni, planner, a, b, comment, name) => {
        return planner.add(uni.weirollZapperExec.sub(a, b, exports.ONE_Val), comment, name);
    },
    erc20: {
