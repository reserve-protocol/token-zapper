...
Object.defineProperty(exports, "DexAggregator", { enumerable: true, get: function () { return DexAggregator_2.DexRouter; } });
...
const createOneInchDexAggregator = (universe, config) => {
    ...
    return new DexAggregator_1.DexRouter(aggregatorName, async (user, destination, input, output, slippage) => {
