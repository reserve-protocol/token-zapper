...
declare const UniBase_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: import("../../base/Approval").Approval[]) => {
    ...
    readonly genUtils: {
        ...
        fraction: (uni: import("../..").Universe<import("../..").Config>, planner: import("../../tx-gen/Planner").Planner, input: import("../../tx-gen/Planner").Value, fraction: bigint, comment: string, name?: string | undefined) => import("../../tx-gen/Planner").ReturnValue;
