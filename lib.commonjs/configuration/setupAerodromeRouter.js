...
const setupAerodromeRouter = async (universe) => {
    ...
    const out = new DexAggregator_1.DexRouter('aerodrome', async (abort, src, dst, input, output, slippage) => {
    ...
    return {
        ...
        addTradeAction: (inputToken, outputToken) => {
            universe.addAction(new ((0, RouterAction_1.RouterAction)('Aerodrome'))(out, universe, routerAddr, inputToken, outputToken, universe.config.defaultInternalTradeSlippage), routerAddr);
        },
    };
};
