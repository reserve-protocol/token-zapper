...
const initialize = async (universe) => {
    ...
    if (universe.chainConfig.config.curveConfig.enable) {
        ...
        const _3CRV = await universe.getToken(Address.from('0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490'));
        ...
        const stkcvx3Crv = await universe.getToken(Address.from('0xee0ac49885719DBF5FC1CDAFD9c752127E009fFa'));
    ...
    const saDAI = await universe.getToken(Address.from('0xF6147b4B44aE6240F7955803B2fD5E15c77bD7ea'));
    const saTokens = [
