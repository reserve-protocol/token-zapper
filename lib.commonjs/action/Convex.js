...
const IBooster__factory_1 = require("../contracts/factories/IBooster__factory");
const IConvexWrapper__factory_1 = require("../contracts/factories/IConvexWrapper__factory");
class ConvexPool {
    convexBooster;
    convexPoolId;
    curveLPToken;
...
const boosterInterface = IBooster__factory_1.IBooster__factory.createInterface();
const wrapperInterface = IConvexWrapper__factory_1.IConvexWrapper__factory.createInterface();
class ConvexDepositAndStake extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn], destination) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(wrapperInterface.encodeFunctionData('deposit', [
            amountsIn.amount,
            destination.address,
    ...
    constructor(convexPool) {
        super(convexPool.stakedConvexDepositToken.address, [convexPool.curveLPToken], [convexPool.stakedConvexDepositToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Callee, [
...
class ConvexDeposit extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn]) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(boosterInterface.encodeFunctionData('deposit', [
    ...
    constructor(convexPool) {
        super(convexPool.convexDepositToken.address, [convexPool.curveLPToken], [convexPool.convexDepositToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Callee, [new Approval_1.Approval(convexPool.curveLPToken, convexPool.convexBooster)]);
        this.convexPool = convexPool;
    }
}
exports.ConvexDeposit = ConvexDeposit;
class ConvexStake extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn], destination) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(wrapperInterface.encodeFunctionData('stake', [
            amountsIn.amount,
            destination.address,
    ...
    constructor(convexPool) {
        super(convexPool.stakedConvexDepositToken.address, [convexPool.convexDepositToken], [convexPool.stakedConvexDepositToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Recipient, [
            new Approval_1.Approval(convexPool.convexDepositToken, convexPool.stakedConvexDepositToken.address),
        ]);
        this.convexPool = convexPool;
    }
}
exports.ConvexStake = ConvexStake;
class ConvexUnstake extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn]) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(wrapperInterface.encodeFunctionData('withdraw', [amountsIn.amount])), this.convexPool.stakedConvexDepositToken.address, 0n, this.gasEstimate(), `Unstake ${amountsIn} on ${this.convexPool.rewardsAddress}, returning deposit token (${this.convexPool.convexDepositToken}) to caller`);
    }
    constructor(convexPool) {
        super(convexPool.stakedConvexDepositToken.address, [convexPool.stakedConvexDepositToken], [convexPool.convexDepositToken], Action_1.InteractionConvention.None, Action_1.DestinationOptions.Callee, []);
        this.convexPool = convexPool;
    }
}
exports.ConvexUnstake = ConvexUnstake;
class ConvexWithdraw extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn]) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(boosterInterface.encodeFunctionData('withdraw', [
            this.convexPool.convexPoolId,
            amountsIn.amount,
    ...
    constructor(convexPool) {
        super(convexPool.stakedConvexDepositToken.address, [convexPool.convexDepositToken], [convexPool.curveLPToken], Action_1.InteractionConvention.None, Action_1.DestinationOptions.Callee, []);
        this.convexPool = convexPool;
    }
}
exports.ConvexWithdraw = ConvexWithdraw;
class ConvexUnstakeAndWithdraw extends Action_1.Action {
    convexPool;
    toString() {
    ...
    async encode([amountsIn]) {
        return new ContractCall_1.ContractCall((0, utils_1.parseHexStringIntoBuffer)(wrapperInterface.encodeFunctionData('withdrawAndUnwrap', [
            amountsIn.amount,
    ...
    constructor(convexPool) {
        super(convexPool.stakedConvexDepositToken.address, [convexPool.stakedConvexDepositToken], [convexPool.curveLPToken], Action_1.InteractionConvention.None, Action_1.DestinationOptions.Callee, []);
        this.convexPool = convexPool;
    }
}
