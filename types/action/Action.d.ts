...
export declare abstract class Action {
    ...
    constructor(address: Address, inputToken: readonly Token[], outputToken: readonly Token[], interactionConvention: InteractionConvention, proceedsOptions: DestinationOptions, approvals: readonly Approval[]);
