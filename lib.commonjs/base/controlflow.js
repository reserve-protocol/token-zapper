...
exports.retryLoop = exports.RetryLoopException = exports.defaultConfig = exports.wait = void 0;
/**
...
exports.defaultConfig = _defaultConfig;
class RetryLoopException extends Error {
    config;
    state;
...
exports.RetryLoopException = RetryLoopException;
/**
 ...
 * @returns
 */
const retryLoop = async (fn, opt) => {
    const config = {
        retryDelay: exports.defaultConfig.retryDelay,
        timeout: exports.defaultConfig.timeout,
        maxRetries: exports.defaultConfig.maxRetries,
        backoff: exports.defaultConfig.backoff,
        ...opt,
    };
    const state = {
        retries: 0,
        currentDelay: config.retryDelay ?? exports.defaultConfig.retryDelay,
        errors: [],
    };
    ...
    while (true) {
        try {
            ...
            await (0, exports.wait)(state.currentDelay);
