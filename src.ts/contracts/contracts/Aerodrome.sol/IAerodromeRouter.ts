...
export interface IAerodromeRouterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, IAerodromeRouter.RouteStruct[]]
  ): string;
  encodeFunctionData(
...
export interface IAerodromeRouter extends BaseContract {
  ...
  functions: {
    ...
    generateZapInParams(
      ...
      routesA: IAerodromeRouter.RouteStruct[],
    ...
    zapIn(
      ...
      amountInA: PromiseOrValue<BigNumberish>,
      amountInB: PromiseOrValue<BigNumberish>,
      zapInPool: IAerodromeRouter.ZapStruct,
      routesA: IAerodromeRouter.RouteStruct[],
      routesB: IAerodromeRouter.RouteStruct[],
      to: PromiseOrValue<string>,
    ...
    zapOut(
      ...
      liquidity: PromiseOrValue<BigNumberish>,
      zapOutPool: IAerodromeRouter.ZapStruct,
      routesA: IAerodromeRouter.RouteStruct[],
      routesB: IAerodromeRouter.RouteStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
