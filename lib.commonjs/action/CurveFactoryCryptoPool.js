...
class CryptoFactoryPoolSwapMint extends CurveFactoryCryptoPoolBase {
    ...
    constructor(pool) {
        super(pool.lpToken.address, pool.underlying, [pool.lpToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Callee, pool.underlying.map((token) => new Approval_1.Approval(token, pool.pool)));
        this.pool = pool;
    }
}
...
class CurveFactoryCryptoPoolAddLiquidityAction extends (0, Action_1.Action)('CurveFactoryCryptoPool') {
    ...
    constructor(universe, pool, tokenIndex) {
        super(pool.underlying[tokenIndex].address, [pool.underlying[tokenIndex]], [pool.lpToken], Action_1.InteractionConvention.ApprovalRequired, Action_1.DestinationOptions.Recipient, pool.underlying.map((token) => new Approval_1.Approval(token === universe.nativeToken
...
class CurveFactoryCryptoPoolRemoveLiquidityAction extends (0, Action_1.Action)('CurveFactoryCryptoPool') {
    ...
    constructor(universe, pool, tokenIndex) {
        super(pool.underlying[tokenIndex].address, [pool.lpToken], [pool.underlying[tokenIndex]], Action_1.InteractionConvention.None, Action_1.DestinationOptions.Callee, []);
        this.universe = universe;
        this.pool = pool;
        this.tokenIndex = tokenIndex;
