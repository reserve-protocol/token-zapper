...
const minter_json_1 = __importDefault(require("./constants/abis/minter.json"));
const minter_child_json_1 = __importDefault(require("./constants/abis/minter_child.json"));
...
const address_provider_json_1 = __importDefault(require("./constants/abis/address_provider.json"));
...
const registry_exchange_json_1 = __importDefault(require("./constants/abis/registry_exchange.json"));
