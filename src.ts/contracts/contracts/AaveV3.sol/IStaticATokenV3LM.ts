...
export interface IStaticATokenV3LMInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getCurrentRewardsIndex",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isRegisteredRewardToken",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "refreshRewardTokens",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type RewardTokenRegisteredEventFilter =
  TypedEventFilter<RewardTokenRegisteredEvent>;
...
export interface IStaticATokenV3LM extends BaseContract {
  ...
  functions: {
    ...
    deposit(
      ...
      depositToAave: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    metaDeposit(
      ...
      depositToAave: PromiseOrValue<boolean>,
      deadline: PromiseOrValue<BigNumberish>,
      permit: IStaticATokenV3LM.PermitParamsStruct,
      sigParams: IStaticATokenV3LM.SignatureParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "RewardTokenRegistered(address,uint256)"(
      reward?: PromiseOrValue<string> | null,
      startIndex?: null
    ): RewardTokenRegisteredEventFilter;
