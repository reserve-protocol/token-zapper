...
export declare const makeCustomRouterSimulator: (url: string, whales: Record<string, string>) => SimulateZapTransactionFunction;
//# sourceMappingURL=ZapSimulation.d.ts.map