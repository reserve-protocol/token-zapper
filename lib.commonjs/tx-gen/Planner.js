...
exports.printPlan = exports.Planner = exports.CommandType = exports.Contract = exports.FunctionCall = exports.CommandFlags = exports.SubplanValue = exports.StateValue = exports.ReturnValue = exports.LiteralValue = void 0;
...
const formatValue = (value, universe) => {
    if (value instanceof ReturnValue) {
        ...
        if (value.param.baseType === 'array') {
            ...
            return `[ ${out[0]
                .map((o) => formatValue(new LiteralValue(value.param.arrayChildren, abi_1.defaultAbiCoder.encode([value.param.arrayChildren], [o])), universe))
                .join(', ')} ]`;
        }
