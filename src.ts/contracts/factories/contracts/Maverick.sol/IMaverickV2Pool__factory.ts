...
import type {
  IMaverickV2Pool,
  IMaverickV2PoolInterface,
} from "../../../contracts/Maverick.sol/IMaverickV2Pool";
...
export class IMaverickV2Pool__factory {
  static readonly abi = _abi;
  static createInterface(): IMaverickV2PoolInterface {
    return new utils.Interface(_abi) as IMaverickV2PoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMaverickV2Pool {
    return new Contract(address, _abi, signerOrProvider) as IMaverickV2Pool;
  }
}
