...
export class Searcher {
    ...
    async findRTokenIntoSingleTokenZap(rTokenQuantity, output, signerAddress, slippage = 0.0) {
        ...
        const outputSwap = new SwapPaths(this.universe, [rTokenQuantity], [
            new SwapPath(this.universe, redeemRTokenForUnderlying.inputs, redeemRTokenForUnderlying.swapPaths.map((i) => i.steps).flat(), redeemRTokenForUnderlying.outputs, redeemRTokenForUnderlying.outputValue, redeemRTokenForUnderlying.destination),
