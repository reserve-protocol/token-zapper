...
class BaseLidoAction extends (0, Action_1.Action)('Lido.Base') {
    ...
    async plan(planner, inputs, _, __) {
...
class BaseStETHAction extends BaseLidoAction {
    ...
    constructor(lido, input, output) {
        super(output.address, [input], [output], Action_1.InteractionConvention.None, Action_1.DestinationOptions.Callee, []);
        this.lido = lido;
        this.input = input;
        this.output = output;
    }
...
class BaseWSTETHAction extends BaseLidoAction {
    ...
    constructor(lido, input, output) {
        super(output.address, [input], [output], input === lido.steth
