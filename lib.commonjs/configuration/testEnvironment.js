...
exports.createForTest = exports.testConfig = void 0;
...
const createForTest = async (c = exports.testConfig) => {
    return await Universe_1.Universe.createWithConfig(null, c, initialize, {
        approvalsStore: new searcher_1.MokcApprovalsStore(),
        tokenLoader: async (_) => {
