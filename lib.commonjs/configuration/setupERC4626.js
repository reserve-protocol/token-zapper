...
const setupERC4626 = async (universe, vaultAddr, protocol) => {
    ...
    for (const { wrappedToken, underlying } of tokens) {
        universe.defineMintable(new ((0, ERC4626_1.ERC4626DepositAction)(protocol))(universe, underlying, wrappedToken), new ((0, ERC4626_1.ERC4626WithdrawAction)(protocol))(universe, underlying, wrappedToken), false);
    }
};
