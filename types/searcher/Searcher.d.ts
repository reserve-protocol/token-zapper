...
export declare class Searcher<const SearcherUniverse extends UniverseWithERC20GasTokenDefined> {
     ...
     **/
    findSingleInputToBasketGivenBasketUnit(inputQuantity: TokenQuantity, rToken: Token, basketUnit: TokenQuantity[], slippage: number): Promise<{
        fullSwap: SwapPaths;
        trading: SwapPaths;
        minting: SwapPaths;
    }>;
    ...
    findRTokenIntoSingleTokenZap(rTokenQuantity: TokenQuantity, output: Token, signerAddress: Address, slippage?: number): Promise<BurnRTokenSearcherResult | TradeSearcherResult>;
    ...
    findSingleInputTokenSwap(input: TokenQuantity, output: Token, destination: Address, slippage?: number, maxHops?: number, dynamicInput?: boolean): Promise<SwapPath[]>;
}
