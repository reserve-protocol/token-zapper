...
const initialize = async (universe) => {
    ...
    if (universe.chainConfig.config.curveConfig.enable) {
        ...
        await addCurvePoolEdges(universe, curvePools);
    }
    ...
    await defineRToken(universe, universe.rTokens.eUSD, Address.from('0x6d309297ddDFeA104A6E89a132e2f05ce3828e07'));
    await defineRToken(universe, universe.rTokens.ETHPlus, Address.from('0xDC690b50824D24F3421a27F4FA8EfCbCF1cAf986'));
};
