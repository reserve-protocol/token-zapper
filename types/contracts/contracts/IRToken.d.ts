...
export interface IRTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "basketsNeeded" | "decimals" | "issuanceAvailable" | "issue" | "issueTo" | "main" | "mint" | "name" | "redeem" | "redeemTo" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "version"): FunctionFragment;
