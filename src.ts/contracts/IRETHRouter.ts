...
export interface IRETHRouterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "optimiseSwapFrom",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "optimiseSwapTo",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface IRETHRouter extends BaseContract {
  ...
  functions: {
    ...
    swapFrom(
      _uniswapPortion: PromiseOrValue<BigNumberish>,
      _balancerPortion: PromiseOrValue<BigNumberish>,
      _minTokensOut: PromiseOrValue<BigNumberish>,
      _idealTokensOut: PromiseOrValue<BigNumberish>,
      _tokensIn: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
