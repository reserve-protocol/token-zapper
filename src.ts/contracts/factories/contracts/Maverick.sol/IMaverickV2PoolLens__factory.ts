...
import type {
  IMaverickV2PoolLens,
  IMaverickV2PoolLensInterface,
} from "../../../contracts/Maverick.sol/IMaverickV2PoolLens";
...
export class IMaverickV2PoolLens__factory {
  static readonly abi = _abi;
  static createInterface(): IMaverickV2PoolLensInterface {
    return new utils.Interface(_abi) as IMaverickV2PoolLensInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMaverickV2PoolLens {
    return new Contract(address, _abi, signerOrProvider) as IMaverickV2PoolLens;
  }
}
