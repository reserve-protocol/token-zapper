...
export interface IPushOperationsInterface extends utils.Interface {
  functions: {
...
export interface IPushOperations extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPushOperationsInterface;
