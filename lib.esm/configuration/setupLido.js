...
export const setupLido = async (universe, stakedTokenAddress, wrappedStakedAddress) => {
    ...
    universe.defineMintable(new MintStETH(universe, stakedToken, stRate), new BurnStETH(universe, stakedToken, stRate));
    ...
    universe.defineMintable(new MintWStETH(universe, stakedToken, wrappedStakedToken, wstRate), new BurnWStETH(universe, stakedToken, wrappedStakedToken, wstRate));
};
