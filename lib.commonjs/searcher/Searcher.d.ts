...
export declare class Searcher {
    ...
    findSingleInputToRTokenZap(userInput: TokenQuantity, rToken: Token, signerAddress: Address): Promise<SearcherResult>;
    externalQuoters(input: TokenQuantity, output: Token, destination: Address): Promise<SwapPath[]>;
    internalQuoter(input: TokenQuantity, output: Token, destination: Address): Promise<SwapPath[]>;
    findSingleInputTokenSwap(input: TokenQuantity, output: Token, destination: Address): Promise<SwapPath[]>;
}
export {};
