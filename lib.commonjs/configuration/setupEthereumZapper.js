...
const setupEthereumZapper = async (universe) => {
    ...
    universe.oracles.push(await PriceOracle_1.PriceOracle.createSingleTokenOracleChainLinkLike(universe, universe.commonTokens.apxETH, Address_1.Address.from("0x19219BC90F48DeE4d5cF202E09c438FAacFd8Bea"), universe.nativeToken));
