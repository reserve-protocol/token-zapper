...
const IRToken__factory_1 = require("../contracts/factories/contracts/IRToken__factory");
'../contracts/factories/@openzeppelin/contracts/token/ERC20/ERC20__factory';
exports.rTokenIFace = IRToken__factory_1.IRToken__factory.createInterface();
class TokenBasket {
    universe;
    address;
    rToken;
