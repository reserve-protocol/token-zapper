...
const UniswapV2Pair__factory_1 = require("../../contracts/factories/@uniswap/v2-core/contracts/UniswapV2Pair__factory");
const INIT_CODE_HASH = (0, utils_2.parseHexStringIntoBuffer)('0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f');
...
const computeV2PoolAddress = (factory, token0, token1) => {
    ...
    return Address_1.Address.from((0, utils_1.getCreate2Address)(factory.address, (0, utils_1.keccak256)(salt), INIT_CODE_HASH));
};
