...
export class Universe {
  ...
  public readonly wrappedTokens = new Map<Token, { mint: Action, burn: Action }>()
  ...
  public createToken (address: Address, symbol: string, name: string, decimals: number) {
...
async function loadERC20FromChain (provider: ethers.providers.Provider, address: Address) {
