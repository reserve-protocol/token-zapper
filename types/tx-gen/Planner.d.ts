...
export declare class TupleLiteral implements Value {
    readonly param: ParamType;
...
export declare class FunctionCall {
    ...
    readonly args: Value[];
    /** @hidden */
    constructor(contract: Contract, flags: CommandFlags, fragment: FunctionFragment, inArgs: Value[], callvalue?: Value);
    /**
...
export declare class Planner {
    ...
    globalComments: Map<Command, string[]>;
