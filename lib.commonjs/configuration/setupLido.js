...
const setupLido = async (universe, stakedTokenAddress, wrappedStakedAddress) => {
    ...
    universe.defineMintable(new StEth_1.MintStETH(universe, stakedToken, stRate), new StEth_1.BurnStETH(universe, stakedToken, stRate));
    ...
    universe.defineMintable(new WStEth_1.MintWStETH(universe, stakedToken, wrappedStakedToken, wstRate), new WStEth_1.BurnWStETH(universe, stakedToken, wrappedStakedToken, wstRate));
};
