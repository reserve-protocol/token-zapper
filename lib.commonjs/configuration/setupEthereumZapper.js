...
const setupEthereumZapper = async (universe) => {
    ...
    const curve = universe.addIntegration('curve', (await (0, setupCurveOnEthereum_1.initCurveOnEthereum)(universe, ethereum_1.PROTOCOL_CONFIGS.convex.booster, 100n))
        .venue);
    ...
    // Set up Lido
    await Promise.all(ethereum_1.PROTOCOL_CONFIGS.erc4626.map(([addr, proto]) => (0, setupERC4626_1.setupERC4626)(universe, [addr], proto, 30n)));
};
