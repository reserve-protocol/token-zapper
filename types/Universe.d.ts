...
export declare class Universe<const UniverseConf extends Config = Config> {
    ...
    readonly dexAggregators: DexRouter[];
    ...
    zap(tokenIn: string, amountIn: bigint, rToken: string, signerAddress: string): Promise<{
        quote: import("./searcher/SearcherResult").MintRTokenSearcherResult | import("./searcher/SearcherResult").TradeSearcherResult;
        cost: {
            units: bigint;
            txFee: TokenQuantity;
            txFeeUsd: TokenQuantity;
    ...
    redeem(rToken: string, amount: bigint, output: string, signerAddress: string): Promise<import("./searcher/SearcherResult").BaseSearcherResult>;
}
export {};
