...
export declare class OffchainOracleRegistry extends PriceOracle {
    ...
    private registry;
    constructor(blocksTTL: number, name: string, fetchPrice: (token: Token) => Promise<TokenQuantity | null>, getCurrentBlock: () => number, provider: Provider);
    register(address: Address, base: Address, oracle: Address): void;
    getOracle(address: Address, base: Address): IEACAggregatorProxy | null;
}
//# sourceMappingURL=OffchainOracleRegistry.d.ts.map