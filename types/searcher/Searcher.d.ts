...
export declare class Searcher<const SearcherUniverse extends UniverseWithERC20GasTokenDefined> {
    ...
    findRTokenIntoSingleTokenZapTx(rTokenQuantity: TokenQuantity, output: Token, signerAddress: Address, slippage?: number, toTxArgs?: ToTransactionArgs): Promise<{
        bestZapTx: {
    ...
    findRTokenIntoSingleTokenZapViaRedeem__(rTokenQuantity: TokenQuantity, output: Token, signerAddress: Address, slippage?: number): AsyncGenerator<BurnRTokenSearcherResult, void, unknown>;
