...
export interface ZapperExecutorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "add" | "assertEqual" | "assertLarger" | "execute" | "fpMul" | "issueRToken" | "mintMaxRToken" | "rawCall" | "sub"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "issueRToken", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>[]
    ]): string;
    ...
    decodeFunctionResult(functionFragment: "issueRToken", data: BytesLike): Result;
...
export interface ZapperExecutor extends BaseContract {
    ...
    functions: {
        ...
        assertEqual(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[void]>;
        assertLarger(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[void]>;
        ...
        issueRToken(token: PromiseOrValue<string>, recipient: PromiseOrValue<string>, amts: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        fpMul(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, scale: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        issueRToken(token: PromiseOrValue<string>, recipient: PromiseOrValue<string>, amts: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        add(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        assertEqual(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        assertLarger(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        execute(commands: PromiseOrValue<BytesLike>[], state: PromiseOrValue<BytesLike>[], tokens: PromiseOrValue<string>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        fpMul(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, scale: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        assertEqual(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        assertLarger(a: PromiseOrValue<BigNumberish>, b: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        execute(commands: PromiseOrValue<BytesLike>[], state: PromiseOrValue<BytesLike>[], tokens: PromiseOrValue<string>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
...
//# sourceMappingURL=ZapperExecutor.d.ts.map