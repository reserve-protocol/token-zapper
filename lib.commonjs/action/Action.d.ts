...
export declare abstract class Action {
    private address_;
    readonly inputToken: readonly Token[];
    readonly outputToken: readonly Token[];
    ...
    get address(): Address;
    constructor(address_: Address, inputToken: readonly Token[], outputToken: readonly Token[], interactionConvention: InteractionConvention, proceedsOptions: DestinationOptions, approvals: readonly Approval[]);
