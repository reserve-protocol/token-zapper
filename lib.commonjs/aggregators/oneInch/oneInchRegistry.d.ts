...
import { OnRetryFunctionReturn, RetryLoopConfig } from '../../base/controlflow';
import { type Token, type TokenQuantity } from '../../entities/Token';
import { Universe } from '../../Universe';
import { DexAggregator } from '../DexAggregator';
import { HttpResponse, SwapErrorDto, type QuoteResponseDto, type SwapResponseDto } from './swagger/oneInchApi';
...
declare const SUPPORTED_ONE_INCH_CHAINS: readonly [1, 56, 137, 10, 42161, 100, 43114, 250, 8217, 1313161554, 31337];
 ...
 */
export declare const createOneInchDexAggregator: (universe: Universe, config?: Readonly<Partial<OneInchConfig>>) => DexAggregator;
export {};
