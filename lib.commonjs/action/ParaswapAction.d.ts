...
declare const ParaswapAction_base: abstract new (_address: Address, inputToken: import("..").Token[], outputToken: import("..").Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
