...
const run = async () => {
    ...
    await universe.searcher.redeem(universe.rTokens._rTokenWithWUSDM.from(3), universe.commonTokens.USDC, index_1.Address.from('0x8e0507c16435caca6cb71a7fb0e0636fd3891df4'), {
