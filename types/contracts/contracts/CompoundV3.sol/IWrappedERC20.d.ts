...
export interface IWrappedERC20Interface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "allow" | "allowance" | "approve" | "balanceOf" | "decimals" | "hasPermission" | "isAllowed" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface IWrappedERC20 extends BaseContract {
    ...
    functions: {
        allow(account: PromiseOrValue<string>, isAllowed_: PromiseOrValue<boolean>, overrides?: Overrides & {
    ...
    callStatic: {
        allow(account: PromiseOrValue<string>, isAllowed_: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        allowance(owner: PromiseOrValue<string>, spender: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
