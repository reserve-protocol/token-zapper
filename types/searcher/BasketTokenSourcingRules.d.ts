...
export declare class PostTradeAction {
    ...
    readonly possibleActions?: Action[] | undefined;
    readonly postTradeActions?: PostTradeAction[] | undefined;
    readonly updateBalances: boolean;
    constructor(inputAsFractionOfCurrentBalance: TokenQuantity[], possibleActions?: Action[] | undefined, postTradeActions?: PostTradeAction[] | undefined, updateBalances?: boolean);
    get action(): Action | undefined;
    get combinations(): number;
    intoAllCombinations(): PostTradeAction[];
    describe(): string[];
    static fromAction(action: Action, update?: boolean): PostTradeAction;
    static fromMultipleChoices(action: Action[], update?: boolean): PostTradeAction;
