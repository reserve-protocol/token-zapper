...
import type * as concentratorSol from "./Concentrator.sol";
export type { concentratorSol };
...
import type * as virtualErc20Sol from "./VirtualERC20.sol";
export type { virtualErc20Sol };
