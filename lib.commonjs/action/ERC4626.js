...
const vaultInterface = contracts_1.IERC4626__factory.createInterface();
...
class ERC4626DepositAction extends Action_1.Action {
    ...
    async quote([amountsIn]) {
        return [
            this.shareToken.from(await contracts_1.IERC4626__factory.connect(this.shareToken.address.address, this.universe.provider).previewDeposit(amountsIn.amount)),
        ];
    }
