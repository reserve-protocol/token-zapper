...
export interface IReadFacetInterface extends utils.Interface {
    functions: {
...
export interface IReadFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IReadFacetInterface;
...
//# sourceMappingURL=IReadFacet.d.ts.map