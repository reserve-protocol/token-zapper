...
// --- ZAPS --
const atricrypto3ZapABI = () => import("../constants/abis/atricrypto3/base_pool_zap.json", { assert: { type: "json" } }).then(i => i.default as JsonFragment[])
const tripoolZapABI = () => import("../constants/abis/3pool/meta_zap_crypto.json", { assert: { type: "json" } }).then(i => i.default as JsonFragment[])
const fraxusdcZapABI = () => import("../constants/abis/fraxusdc/meta_zap_crypto.json", { assert: { type: "json" } }).then(i => i.default as JsonFragment[])
