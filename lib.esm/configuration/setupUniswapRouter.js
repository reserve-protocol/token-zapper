...
import { AlphaRouter, CachingGasStationProvider, CachingTokenListProvider, CachingTokenProviderWithFallback, CachingV2PoolProvider, CachingV3PoolProvider, CurrencyAmount, EIP1559GasPriceProvider, EthEstimateGasSimulator, LegacyGasPriceProvider, LegacyRouter, NodeJSCache, OnChainGasPriceProvider, OnChainQuoteProvider, SwapType, TokenPropertiesProvider, TokenProvider, UniswapMulticallProvider, V2PoolProvider, V3PoolProvider, } from '@uniswap/smart-order-router';
...
export const setupUniswapRouter = async (universe) => {
    ...
    const ethEstimateGasSimulator = new EthEstimateGasSimulator(universe.chainId, universe.provider, v2PoolProvider, v3PoolProvider, portionProvider);
    ...
    const computeRoute = async (abort, input, output, slippage) => {
        ...
        const route = await legacy.route(inp, outp, TradeType.EXACT_INPUT, {
