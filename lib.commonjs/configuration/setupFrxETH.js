...
const setupFrxETH = async (universe, config) => {
    ...
    const frxEthOracle = PriceOracle_1.PriceOracle.createSingleTokenOracle(universe, frxETH, async () => {
    ...
    const sfrxEthOracle = PriceOracle_1.PriceOracle.createSingleTokenOracle(universe, sfrxETH, async () => {
