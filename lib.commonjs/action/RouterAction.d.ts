...
declare const RouterAction_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
...
export declare class RouterAction extends RouterAction_base {
    ...
    quote([amountsIn]: TokenQuantity[]): Promise<TokenQuantity[]>;
    constructor(dex: DexRouter, universe: Universe, router: Address, inputToken: Token, outputToken: Token, slippage: bigint);
    toString(): string;
}
export {};
