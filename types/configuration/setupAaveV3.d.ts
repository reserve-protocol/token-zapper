...
declare const BaseAaveAction_base: abstract new (_address: Address, inputToken: Token[], outputToken: Token[], _interactionConvention: InteractionConvention, _proceedsOptions: DestinationOptions, _approvals: Approval[]) => {
    ...
    readonly genUtils: {
        ...
        fraction: (uni: Universe<import("./ChainConfiguration").Config>, planner: gen.Planner, input: gen.Value, fraction: bigint, comment: string, name?: string | undefined) => gen.Value | gen.ReturnValue;
        sub: (uni: Universe<import("./ChainConfiguration").Config>, planner: gen.Planner, a: bigint | gen.Value, b: bigint | gen.Value, comment: string, name?: string | undefined) => gen.ReturnValue;
        erc20: {
...
export {};
//# sourceMappingURL=setupAaveV3.d.ts.map