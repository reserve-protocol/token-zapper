...
export interface IStETHInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "getPooledEthByShares" | "getSharesByPooledEth" | "submit" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
