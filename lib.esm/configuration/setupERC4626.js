...
export const setupERC4626 = async (universe, vaultAddr, protocol) => {
    ...
    for (const { wrappedToken, underlying } of tokens) {
        universe.defineMintable(new (ERC4626DepositAction(protocol))(universe, underlying, wrappedToken), new (ERC4626WithdrawAction(protocol))(universe, underlying, wrappedToken), false);
    }
};
