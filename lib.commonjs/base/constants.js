...
exports.CHAINLINK = exports.simulationUrls = exports.TRADE_SLIPPAGE_DENOMINATOR = exports.USD_ADDRESS = exports.CHAINLINK_BTC_TOKEN_ADDRESS = exports.ZERO = exports.BTC_TOKEN_ADDRESS = exports.GAS_TOKEN_ADDRESS = exports.FEE_SCALE = void 0;
...
exports.TRADE_SLIPPAGE_DENOMINATOR = 100000n;
...
exports.CHAINLINK = {
    ETH: Address_1.Address.from(exports.GAS_TOKEN_ADDRESS),
    BTC: Address_1.Address.from(exports.CHAINLINK_BTC_TOKEN_ADDRESS),
    USD: Address_1.Address.from(exports.USD_ADDRESS),
};
