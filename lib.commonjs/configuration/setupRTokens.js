...
const loadRToken = async (universe, rTokenAddress, mainAddr) => {
    ...
    const basketHandler = new TokenBasket_1.TokenBasket(universe, Address_1.Address.from(basketHandlerAddress), token, Address_1.Address.from(assetRegistryAddress));
