...
export declare const COMMON_TOKENS: {
    ...
    readonly ETHx: "0xA35b1B31Ce002FBF2058D22F30f95D405200A15b";
    readonly sdgnETH: "0x5bdd1fa233843bfc034891be8a6769e58f1e1346";
    readonly 'ETH+ETH-f': "0xe8a5677171c87fCB65b76957f2852515B404C7b1";
};
...
export declare const ethereumConfig: {
    ...
    readonly addresses: {
        readonly commonTokens: {
            ...
            readonly ETHx: import("..").Address;
            readonly sdgnETH: import("..").Address;
            readonly 'ETH+ETH-f': import("..").Address;
        };
        readonly rTokens: {
