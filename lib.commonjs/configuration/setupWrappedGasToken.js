...
const setupWrappedGasToken = async (universe, wrappedTokenName = "ERC20GAS") => {
    ...
    const wrappedGasTokenActions = universe.defineMintable(new WrappedNative_1.DepositAction(universe, wrappedToken), new WrappedNative_1.WithdrawAction(universe, wrappedToken), true);
