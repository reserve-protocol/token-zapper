...
const run = async () => {
    ...
    const testUserAddr = Address.from(walletDeployer.address);
    {
        ...
        try {
            ...
            console.log("Finding");
            let res = await searcher.findSingleInputToRTokenZap(universe.nativeToken.from("0.0005"), universe.rTokens.testUSD, testUserAddr, 0.0);
            // console.log("???")
            // console.log(res)
